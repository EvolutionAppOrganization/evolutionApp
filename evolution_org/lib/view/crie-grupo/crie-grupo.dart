...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  var longText = RichText(
    text: TextSpan(
      ...
      children: <TextSpan>[
        TextSpan(text: "Aqui você colocará as pessoas que fazem parte do seu time, os seus liderados.",
    ...
    text: TextSpan(
      ...
      children: <TextSpan>[
        TextSpan(text: "Cada pessoa só pode ser adicionada à um único grupo. ",
        style: TextStyle(height: 1.5)
        )
      ],
    ),
